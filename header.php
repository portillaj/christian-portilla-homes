...
<head>
    ...
    <title>Christian Portilla Homes - Real Estate Realtor</title>
    <link rel="stylesheet" href="stylesheets/css/bootstrap.min.css">
    <script src="https://use.fontawesome.com/380ac6a2bf.js"></script>
...
<!--NAVBAR SECTION -->
    ...
    <nav class="navbar navbar-expand-lg my-nav">
        ...
        <h2 class="navbar-brand logo" href="#">Christian Portilla</h2>
        <hr class="logo-break"/>
        <h3 class="sub-logo">- Real Estate -</h3>
        </div>
        <button class="navbar-toggler bg-dark text-light" type="button" data-toggle="collapse" data-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
            <span class="navbar-toggler-icon mr-2 pr-5 text-center mt-2 ml-3">Menu</span>
        </button>
